...
# spec1 = dict(op1_height=5, op1_width=5, op1_strides=[1, 1, 1, 1],
#              op2_height=5, op2_width=5, op2_strides=[1, 1, 1, 1],
#              hidden_channels=256, target_shape=[56, 56, 128],
#              inv_input_name='conv3_1/relu:0', inv_target_name='pool2:0',
#              rec_name='pool2_rec', add_loss=False)
#
# spec2 = dict(op1_height=5, op1_width=5, op1_strides=[1, 4, 4, 1],
#              op2_height=5, op2_width=5, op2_strides=[1, 1, 1, 1],
#              hidden_channels=256, target_shape=[56, 56, 128],
