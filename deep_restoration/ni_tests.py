...
c1l_prior = ChannelICAPrior('conv1_lin:0', 1e-5, 'alexnet', [5, 5], input_scaling=1.0,
...
params = dict(classifier='alexnet',
              modules=modules,
              log_path='../logs/net_inversion/alexnet/c1l_tests_16_08/6_MSE_c4l_CICA_c1l/1e-5/',
              load_path='')
...
ni.train_pre_image('../data/selected/images_resized/red-fox.bmp', optim_name='adam',
                   ...
                   lr_lower_points=((0, 1e-1),), grad_clip=10000.,
