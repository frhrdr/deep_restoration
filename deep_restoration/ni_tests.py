...
params = dict(classifier='alexnet',
              modules=modules,
              log_path='../logs/net_inversion/alexnet/c4_rec/mse4_pimg_pc2_1e-9/',
              load_path='')
...
ni.train_pre_image('../data/selected/images_resized/red-fox.bmp', optim_name='adam',
                   ...
                   lr_lower_points=((0, 0.01), (1000, 0.003), (1200, 0.001), (2000, 0.0003),
                                    (6000, 0.0001), (10000, 0.00003), (15000, 0.00001)))
