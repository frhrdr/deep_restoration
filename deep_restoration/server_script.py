...
# add_flattened_validation_set(num_patches=1000, ph=5, pw=5, classifier='alexnet', map_name='conv1/lin:0',
#                              n_channels=96, n_feats_white=2400, whiten_mode='zca', batch_size=100,
#                              mean_mode='gc', sdev_mode='gc')
#
