...
# make_flattened_patch_data(num_patches=100000, ph=5, pw=5, classifier='alexnet', map_name='conv2/lin:0',
#                           n_channels=256,
#                           save_dir='../data/patches/alexnet/conv2_lin_5x5_6400feats_mean_lf_sdev_rescaled_' + str(1/255) + '/',
#                           n_feats_white=3200, whiten_mode='pca', batch_size=100,
#                           mean_mode='lf', sdev_mode=1/255,
#                           raw_mat_load_path='../data/patches/alexnet/conv2_lin_5x5_3200feats_mean_lc_sdev_gc/raw_mat.npy')
...
c1l_prior.train_prior(batch_size=500, num_iterations=30000, lr=3e-5,
                      lr_lower_points=((5000, 1e-0), (8000, 1e-1), (12000, 3e-2), (16000, 1e-2),
                      ...
                      prev_ckpt=8000, optimizer_name='adam',
