...
dc2 = DeconvConvModule(inv_input_name='pool1:0', inv_target_name='lrn1:0',
...
dc3 = DeconvConvModule(inv_input_name='lrn1:0', inv_target_name='conv1/lin:0',
                       hidden_channels=96, rec_name='c1l_rec',
                       op1_hw=[8, 8], op1_strides=[1, 1, 1, 1], op2_hw=[8, 8], op2_strides=[1, 1, 1, 1],
                       name='DC3',
                       subdir='run1', trainable=True)

dc4 = DeconvConvModule(inv_input_name='conv1/lin:0', inv_target_name='rgb_scaled:0',
                       hidden_channels=96, rec_name='rgb_rec',
                       op1_hw=[11, 11], op1_strides=[1, 4, 4, 1], op2_hw=[11, 11], op2_strides=[1, 1, 1, 1],
                       op1_pad='VALID',
                       name='DC4',
                       subdir='run4', trainable=True)
...
ni.train_on_dataset(n_iterations=5000, batch_size=10, test_set_size=200, test_freq=100,
