...
#                           n_channels=3,
#                           save_dir='../data/patches/image/8x8_mean_gc_sdev_gc/',
#                           n_feats_white=191, whiten_mode='pca', batch_size=100,
#                           mean_mode='gc', cov_mode='gc',
...
ica_prior.train_prior(batch_size=500, num_iterations=300000, lr=3e-5,
                      lr_lower_points=((0, 1e-1), (10000, 3e-2), (20000, 1e-2),(25000, 1e-3),),
