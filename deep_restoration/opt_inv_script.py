...
img_prior = FoEFullPrior('pre_featmap/read:0', 1e-2, 'alexnet', [8, 8], 1.0, n_components=512, n_channels=3,
...
log_path = '../logs/opt_inversion/alexnet/slim_vs_img/c2l_to_c1l/pre_image_8x8_full_prior/1e-2'
