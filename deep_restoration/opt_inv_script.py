...
modules = [split4, mse4, pre_mse, img_prior]
log_path='../logs/opt_inversion/alexnet/pre_featmap/img_12x12/'
...
pre_featmap_init = np.reshape(np.load(ni.log_path + 'mats/rec_3500.npy'), [1, 224, 224, 3])
...
ni.train_pre_featmap('../data/selected/images_resized/red-fox.bmp', n_iterations=10000, optim_name='adam',
                     ...
                     pre_featmap_init=pre_featmap_init, ckpt_offset=3500,
