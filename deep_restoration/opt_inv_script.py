...
slimprior = FoEFullPrior('pre_featmap/read:0', 3e-9, 'alexnet', [3, 3], 1.0, n_components=2000, n_channels=96,
...
log_path = '../logs/opt_inversion/alexnet/c2l_to_c1l/mse/sgd/run3/'
...
ni.train_pre_featmap('../data/selected/images_resized_227/red-fox.bmp', n_iterations=20000, optim_name='sgd',
                     lr_lower_points=((1e+0, 1e-2),), grad_clip=10000.,
