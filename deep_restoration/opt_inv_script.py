...
chanprior = FoEChannelwisePrior(tensor_names='pre_featmap/read:0', weighting=1e-3, classifier='alexnet',
...
log_path = '../logs/opt_inversion/alexnet/c2l_to_c1l/chan_prior/adam/run4/'
