...
# img_prior = FoEFullPrior('pre_featmap:0', 1e-8, 'alexnet', [8, 8], 1.0, n_components=512, n_channels=3,
...
img_prior = get_default_prior('full512logistic', custom_weighting=1e-4)

modules = [split2, mse2, pre_mse, img_prior]
...
log_path = '../logs/opt_inversion/alexnet/img_prior_comp/c2l_to_img/8x8_gc_gc_logistic/1e-4/'
